  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-8.mb-4.mb-lg-0.order-last.order-lg-first(data-aos="fade-right")
          ...
          p Existen diferentes sistemas de costeo, para obtener el costo de un producto o servicio innovador, por lo que la entidad elige al que le proporcione información, que le permita elaborar estrategias para cumplir sus objetivos. Algunos de ellos son:
    ...
    .tarjeta.color-primario.p-4.mb-4(data-aos="fade-up")
      .row.justify-content-around.align-items-center
        ...
        .col
          .row.justify-content-between.align-items-center
            .col.mb-3.mb-sm-0
              p.m-0.text-bold Alternativas de Inversión
              p.m-0 Se hace un llamado a la acción para que el aprendiz pueda observar el video llamado: “Alternativas de Inversión” para ampliar el concepto de Análisis de tasa de retorno por medio evaluar las alternativas de Inversión:
            .col-sm-auto
              a.boton.color-acento-botones.texto-blanco(href="https://youtu.be/nHjl83QvSUw" target="_blank")
                span Ver video
    ...
    SlyderA(tipo="b").color1.p-2.p-md-3.p-lg-4.mb-5 
      ...
      .row
        .col-lg-12.col-11
          ...
          .row.justify-content-center
            .col-10.col-md-11.col-lg-5              
              p Los indicadores internos, permiten identificar los procesos internos de las empresas, como por ejemplo los ingresos; mientras que los externos miden el impacto de la empresa en el mercado, un ejemplo es los porcentajes de clientes satisfechos con algún producto.
            .col-10.col-md-11.col-lg-6
              figure.mb-4
      ...
      .row
        .col-lg-12.col-11
          ...
          .row.justify-content-center
            .col-10.col-md-11.col-lg-5              
              p Para la eficacia, mide el funcionamiento objetivo de la organización como la cantidad de productos que se fabrican al mes. La eficiencia, permite verificar todos los recursos con los que cuentan las empresas para de este modo lograr resultados superiores a los que se planifican inicialmente.
            .col-10.col-md-11.col-lg-6
              figure
    ...
    .bg_17      
      ...
      p.mb-4 Ahora bien, después de conocer los beneficios que tiene los indicadores de innovación, es importante conocer la manera de interpretar los indicadores KPI, a través del siguiente video: 
      ...
      .row.justify-content-around.align-items-center
        ...
        .col
          .row.justify-content-between.align-items-center
            .col.mb-3.mb-sm-0
              p.m-0.text-bold KPI
              p.m-0 Se hace un llamado a la acción para que el aprendiz pueda observar el video llamado: “Interpretación de indicadores de gestión (KPI)” para ampliar el concepto de indicadores”:
            .col-sm-auto
              a.boton.color-acento-botones.texto-blanco(href="https://www.youtube.com/watch?v=nCUYv5oPwJY" target="_blank")
                span Ver video
    ...
    .row.justify-content-center.mb-4
      .col-lg-4
        h4 Formas de implementar el proceso evaluativo
        ...
        .bg_18.p-4
          .row.justify-content-center
            ...
            .col-lg-10
              ...
              p.m-0 Informa con cifras expresarse en números o porcentajes de medición. numéricas de los procesos de avance. 
      ...
      .col-lg-10             
        .bloque-texto-g.color-secundario.p-3.p-sm-4.p-md-5
          ...
          .bloque-texto-g__texto.p-4
            p.mb-0 Existen múltiples Herramientas y metodologías para el seguimiento y evaluación, pero la más utilizada son los Diagramas de Gantt, ya que es aplicable para la gestión de cualquier tipo de proyectos tanto para la planeación como el seguimiento y apoya la evaluación constante de la innovación por medio de gráficas de control que permiten evaluar lo proyectado con lo cumplido. La razón de su gran uso corresponde a su facilidad tanto en la diagramación de forma manual como se realizaba desde los años 1910 por su creador Henry Gantt hasta la implementación actual con diferentes softwares especializados que han adoptado su metodología.
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-6(data-aos="fade-right")        
        ul.lista-ul--color
          li 
            i.fas.fa-check-circle
            | Planificar y realiza seguimientos de forma gráfica y analítica la ejecución de un proyecto de innovación.
          li 
            i.fas.fa-check-circle
            | Define cronograma y realiza seguimientos del proyecto, indicando quién y qué actividad se realizará, así como también cuando se realizará y cuánto tiempo tardará.
          li 
            i.fas.fa-check-circle
            | Establecer recursos: tanto en equipos, máquinas, materiales como personal responsable.
          li 
            i.fas.fa-check-circle
            | Controlar y medir progresos: con lo cual se valida el avance del proyecto y los niveles de utilización de los recursos.
          li 
            i.fas.fa-check-circle
          ...
          li 
            i.fas.fa-check-circle
            | Visualizar en barras de tiempo el escenario proyectado y el cumplimiento real.
    ...
    p(data-aos="fade-right") Es una herramienta lúdica, que organiza la información de los proyectos, discusiones, entradas o chats mediante tarjetas para que después esta sea arrastrada y soltada en diferentes listas o páginas. Lo invitamos a conocer más acerca de esta herramienta en el siguiente recurso:
